...
Begin VB.Form frmSalesPerPartByDate 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Sales Per Part By Date Parameter"
   ClientHeight    =   2535
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   4665
   Icon            =   "frmSalesPerPartByDate.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.PictureBox picHeader 
      ...
      Begin VB.Image Image1 
         Height          =   720
         Left            =   120
         Picture         =   "frmSalesPerPartByDate.frx":054A
         Top             =   120
         Width           =   720
      End
   ...
   End
End
Attribute VB_Name = "frmSalesPerPartByDate"
...
sSQL = "SELECT qry_Sales_Order_Detail.* " & _
    ...
    With rptSalesPerPartByDate
        ...
        .txtDetailNo.DataField = "SalesOrderDetailID"
...
CenterForm frmSalesPerPartByDate
...
Set frmSalesPerPartByDate = Nothing
End Sub
