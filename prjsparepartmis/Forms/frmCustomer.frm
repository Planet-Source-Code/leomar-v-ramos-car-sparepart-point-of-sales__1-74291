...
Set RS_CUSTOMER = New ADODB.Recordset
If RS_CUSTOMER.State = adStateOpen Then RS_CUSTOMER.Close
RS_CUSTOMER.Open srcSQL, CN, adOpenDynamic, adLockPessimistic
...
On Error Resume Next
srcCustomer = lvList.SelectedItem.Index
srcRecord = lvList.ListItems.Item(srcCustomer).Text
Call RefreshRecSum
End Sub
...
Select Case srcPerformWhat
    ...
    Case "Delete" 'Delete
            ...
            If MsgBox("Are you sure you want to delete this record?", vbCritical + vbYesNo) = vbYes Then
                sSQL_Delete "DELETE FROM Customers WHERE CustomerID='" & srcRecord & "'"
...
With lvList
    ...
    .ColumnHeaders.Add , , "LandlineNo"
    .ColumnHeaders.Add , , "FaxNo"
    .ColumnHeaders.Add , , "OwnerName"
    .ColumnHeaders.Add , , "Email"
    .ColumnHeaders.Add , , "Website"
    
    .ListItems.Clear
    Do While Not RS_CUSTOMER.EOF
    Set srcItem = .ListItems.Add(, , RS_CUSTOMER.Fields("CustomerID"), 1, 1)
        srcItem.SubItems(1) = RS_CUSTOMER.Fields("Description")
        srcItem.SubItems(2) = RS_CUSTOMER.Fields("Address")
        srcItem.SubItems(3) = RS_CUSTOMER.Fields("LandlineNo")
        srcItem.SubItems(4) = RS_CUSTOMER.Fields("FaxNo")
        srcItem.SubItems(5) = RS_CUSTOMER.Fields("OwnerName")
        srcItem.SubItems(6) = RS_CUSTOMER.Fields("Email")
        srcItem.SubItems(7) = RS_CUSTOMER.Fields("Website")
...
Private Sub RefreshRecSum()
    lblRecSum.Caption = "Record: " & srcCustomer & " of " & lvList.ListItems.Count
End Sub
